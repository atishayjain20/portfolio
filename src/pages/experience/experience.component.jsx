          ...
          <Tilt options={{ max: 25 }}>
            <Card>
              ...
              <Card.Body className="d-flex justify-content-center flex-column">
                <div>
                  <Card.Title className="text-center">Poornima College of Engineering</Card.Title>
                </div>
                <div>
                  <Card.Text className="text-center style">
                    ...
                    <ul className="text-left">
                      <li><strong>Current Aggregate is 9.0 SGPA</strong></li>
                      ...
                      <li><strong>Competitive Programmer(Codechef,Hackerrank)</strong></li>
                      <li><strong>Hackathons Attended(LNMHacks 4.0,Build-A-Thon,RTU SBH,IIS)</strong>
                      </li>
